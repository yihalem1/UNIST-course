...
matches, cover_keypoints, desk_keypoints = matchPicsORB(cover_image, desk_image, num_matches=9)

# Compute the homography matrix (H_desk_to_cover) that maps points from the desk image to the cover image.
H_desk_to_cover = computeH_norm(cover_keypoints, desk_keypoints)
...
# Save the results.
cv2.imwrite('../result/wrapped_norm_image.jpg', warped_cover)